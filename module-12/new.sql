...
('June Santos', 'Compliance Manager'),       -- EmployeeID = 1
('Phoenix Two Star', 'Office Manager'),      -- EmployeeID = 2
('Jake Willson', 'CFA'),                      -- EmployeeID = 3
('Ned Willson', 'CFA'),                       -- EmployeeID = 4
('John Doe', 'Advisor'),                      -- EmployeeID = 5
('Jane Roe', 'Intern');                       -- EmployeeID = 6

-- Insert data into Clients with EmployeeID
INSERT INTO Clients (Name, Address, Phone, Email, ClientCreationDate, EmployeeID) VALUES
('Alice Smith', '123 Main St, NM', '123-456-7890', 'alice@example.com', '2024-06-01', 3),
('Bob Jones', '456 Elm St, NM', '234-567-8901', 'bob@example.com', '2024-06-15', 4),
('Charlie Brown', '789 Oak St, NM', '345-678-9012', 'charlie@example.com', '2024-07-05', 5),
('Diana Prince', '101 Pine St, NM', '456-789-0123', 'diana@example.com', '2024-07-20', 2),
('Eve Adams', '202 Maple St, NM', '567-890-1234', 'eve@example.com', '2024-08-10', 6),
('Frank Wilson', '303 Birch St, NM', '678-901-2345', 'frank@example.com', '2024-08-25', 3),
('Grace Lee', '404 Cedar St, NM', '789-012-3456', 'grace@example.com', '2024-09-05', 4),
('Henry Ford', '505 Ash St, NM', '890-123-4567', 'henry@example.com', '2024-10-01', 2),
('Ivy Green', '606 Pine St, NM', '901-234-5678', 'ivy@example.com', '2024-11-15', 5),
('Jake White', '707 Oak St, NM', '012-345-6789', 'jake@example.com', '2024-11-25', 3);
...
-- Insert data into Employees (Note: Already inserted above)
-- Duplicate insertions removed to maintain data integrity
