...
-- changed the command from using mysql_native_password as authentication method
CREATE USER 'movies_user'@'localhost' IDENTIFIED WITH caching_sha2_password BY 'P0pC0rn!';
